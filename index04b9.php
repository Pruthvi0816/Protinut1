            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero__content sec-title">
                        ...
                        <h1 class="title mb-25 wow fadeInUp" data-wow-delay="150ms" data-wow-duration=".6s">Today
                            Elevate Your Energy Levels Protinut</h1>
                        <div class="hero__action ul_li wow fadeInUp" data-wow-delay="300ms" data-wow-duration=".6s">
                            <a class="thm-btn mr-45 mt-30" href="shop-single.php">BUY NOW</a>
                ...
                <div class="col-lg-6">
                    <div class="hero__product text-md-end">
                        <img class="wow fadeInRight" data-wow-delay="300ms" data-wow-duration=".6s"
                            src="assets/img/shop/hero_product.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8 pb-col-8">
                        <div class="row g-20">
                            <div class="col-lg-6 col-md-6 mt-20">
                                <div class="popular-product-item ul_li">
                                    <div class="xb-item--img">
                                        <a href="shop-single.php"><img src="assets/img/shop/product_17.png" alt=""></a>
                                    </div>
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--title"><a href="shop-single.php">xplode powder</a></h3>
                                        ...
                                        <div class="xb-item--action ul_li_between">
                                            ...
                                            <a class="xb-item--cart" href="shop-single.php"><img
                                                    src="assets/img/icon/bag.svg" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 mt-20">
                                <div class="popular-product-item ul_li">
                                    <div class="xb-item--img">
                                        <a href="shop-single.php"><img src="assets/img/shop/product_02.png" alt=""></a>
                                    </div>
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--title"><a href="shop-single.php">Ultimate Havoc</a></h3>
                                        <div class="xb-item--rating-inner ul_li">
                                            <ul class="xb-item--rating ul_li">
                                                <li><img src="assets/img/icon/star.png" alt=""></li>
                                                <li><img src="assets/img/icon/star.png" alt=""></li>
                            ...
                            <div class="col-lg-6 col-md-6 mt-20">
                                <div class="popular-product-item ul_li">
                                    <div class="xb-item--img">
                                        <a href="shop-single.php"><img src="assets/img/shop/product_03.png" alt=""></a>
                                    </div>
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--title"><a href="shop-single.php">xplode powder</a></h3>
                                        <div class="xb-item--rating-inner ul_li">
                            ...
                            <div class="col-lg-6 col-md-6 mt-20">
                                <div class="popular-product-item ul_li">
                                    <div class="xb-item--img">
                                        <a href="shop-single.php"><img src="assets/img/shop/product_04.png" alt=""></a>
                                    </div>
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--title"><a href="shop-single.php">xplode powder</a></h3>
                                        <div class="xb-item--rating-inner ul_li">
                ...
                <div class="col-lg-5 offset-lg-3 col-md-6 mt-30">
                    <div class="feature-content">
                        <div class="sec-title sec-title--big sec-title--white">
                            ...
                            <p>At Protinut, we're dedicated to helping you on a health journey. Our mission is to
                                provide .</p>
            ...
            <div class="product-slider swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide product-item text-center">
                        <div class="xb-item--img">
                            <a href="shop-single.php"><img src="assets/img/shop/product_05.png" alt=""></a>
                        </div>
                        <div class="xb-item--holder">
                            <h3 class="xb-item--title"><a href="shop-single.php">iso whey powder</a></h3>
                        ...
                        <div class="xb-item--action ul_li mt-20">
                            ...
                            <a href="shop-single.php"><span class="xb-item--cart-icon"><img
                                        src="assets/img/icon/bag.svg" alt=""></span><span class="xb-item--cart">add to
                                    cart</span></a>
                        </div>
                    </div>
                    <div class="swiper-slide product-item text-center">
                        <div class="xb-item--img">
                            <a href="shop-single.php"><img src="assets/img/shop/product_10.png" alt=""></a>
                        </div>
                        <div class="xb-item--holder">
                            <h3 class="xb-item--title"><a href="shop-single.php">juice guard</a></h3>
                            <div class="xb-item--rating-inner ul_li_center">
                                <ul class="xb-item--rating ul_li">
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
                    ...
                    <div class="swiper-slide product-item text-center">
                        <div class="xb-item--img">
                            <a href="shop-single.php"><img src="assets/img/shop/product_11.png" alt=""></a>
                        </div>
                        <div class="xb-item--holder">
                            <h3 class="xb-item--title"><a href="shop-single.php">real whey</a></h3>
                            <div class="xb-item--rating-inner ul_li_center">
                                <ul class="xb-item--rating ul_li">
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
                    ...
                    <div class="swiper-slide product-item text-center">
                        <div class="xb-item--img">
                            <a href="shop-single.php"><img src="assets/img/shop/product_12.png" alt=""></a>
                        </div>
                        <div class="xb-item--holder">
                            <h3 class="xb-item--title"><a href="shop-single.php">creatine powder</a></h3>
                            <div class="xb-item--rating-inner ul_li_center">
                                <ul class="xb-item--rating ul_li">
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
                    ...
                    <div class="swiper-slide product-item text-center">
                        <div class="xb-item--img">
                            <a href="shop-single.php"><img src="assets/img/shop/product_13.png" alt=""></a>
                        </div>
                        <div class="xb-item--holder">
                            <h3 class="xb-item--title"><a href="shop-single.php">beta alnine</a></h3>
                            <div class="xb-item--rating-inner ul_li_center">
                                <ul class="xb-item--rating ul_li">
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
                                    <li><img src="assets/img/icon/star.png" alt=""></li>
            ...
            <div class="row justify-content-center mt-none-30">
                    ...
                    <div class="xb-pricing">
                        ...
                        <div class="xb-item--body">
                            <ul class="xb-item--list list-unstyled">
                                <li><img src="assets/img/icon/p_check.svg" alt="">1 Person User Protinut</li>
                            ...
                            <div class="xb-item--btn">
                                <a class="thm-btn w-100 text-center mt-45" href="#!"><img src="assets/img/icon/bag.svg"
                                        alt="">BUY NOW</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mt-30">
                    <div class="xb-pricing active">
                        ...
                        <div class="xb-item--body">
                            <ul class="xb-item--list list-unstyled">
                                <li><img src="assets/img/icon/check_h.svg" alt="">3 Person User Protinut</li>
                ...
                <div class="col-lg-4 col-md-8 mt-30">
                    <div class="xb-pricing">
                        ...
                        <div class="xb-item--body">
                            <ul class="xb-item--list list-unstyled">
                                <li><img src="assets/img/icon/p_check.svg" alt="">6 Person User Protinut</li>
        ...
        <div class="container">
            ...
            <div class="row mt-none-30 justify-content-center">
                <div class="col-lg-4 col-md-6 mt-30">
                    <div class="xb-blog">
                        <div class="xb-item--img">
                            <a href="blog-single.php"><img src="assets/img/blog/img_01.jpg" alt=""></a>
                            <div class="xb-item--date">28 <br><span>sep</span></div>
                        </div>
                        <div class="xb-item--holder">
                            <span class="xb-item--author"><img src="assets/img/icon/user.svg" alt="">Steven
                                Timothy</span>
                            <h3 class="xb-item--title border-effect"><a href="blog-single.php">The Power of Adaptogens
                                    Stress Relief and..</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-30">
                    <div class="xb-blog">
                        <div class="xb-item--img">
                            <a href="blog-single.php"><img src="assets/img/blog/img_02.jpg" alt=""></a>
                            <div class="xb-item--date">28 <br><span>sep</span></div>
                        </div>
                        <div class="xb-item--holder">
                            <span class="xb-item--author"><img src="assets/img/icon/user.svg" alt="">Andrew Brian</span>
                            <h3 class="xb-item--title border-effect"><a href="blog-single.php">The Role of Supplements
                                    in Athletic Perf..</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-8 mt-30">
                    <div class="xb-blog">
                        <div class="xb-item--img">
                            <a href="blog-single.php"><img src="assets/img/blog/img_03.jpg" alt=""></a>
                            <div class="xb-item--date">28 <br><span>sep</span></div>
                        </div>
                        <div class="xb-item--holder">
                            <span class="xb-item--author"><img src="assets/img/icon/user.svg" alt="">Andrew Brian</span>
                            <h3 class="xb-item--title border-effect"><a href="blog-single.php">Discover the Benefits of
                                    Essential Nutrients..</a></h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-inner">
            ...
            <div class="footer-bottom mt-50 ul_li_between">
                <div class="footer-copyright mt-30">
                    Copyright © 2024 Protinut All rights reserved.
                </div>
...
<!-- Mirrored from html.xpressbuddy.com/Protinut/?storefront=envato-elements by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Feb 2026 11:44:32 GMT -->
